use std::fs;
// There is more solutions in this folder, take a look at them if you want to see more solutions.
fn main() {
    ...
    println!(
        "Last valid user: {}",
        valid_users[valid_users.len() - 1].to_string()
    );
